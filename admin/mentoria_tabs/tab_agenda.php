    ...
    <div class="modal-content">
        ...
        <form method="POST">
            ...
            <div class="form-group" style="margin-top: 15px;">
                ...
                <input type="text" name="meet_link" id="meet_link" placeholder="meet.google.com/xyz-abcd-123" required class="input-modern" style="width:100%; padding: 10px; margin-top:5px; background:var(--input-bg); border:1px solid rgba(255,255,255,0.1); color:var(--white);">
            </div>
