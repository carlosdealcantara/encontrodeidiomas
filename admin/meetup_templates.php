                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="comunidade_alvo" id="comunidade_alvo" class="form-control" required>
                            <option value="global">🌐 Global — Brasil + Global (todos os grupos)</option>
                            <option value="brasil">🇧🇷 Brasil — apenas grupos Brasil</option>
                        </select>
                        <small style="color: var(--text-dim);">Use {BR}...{/BR} e {GLOBAL}...{/GLOBAL} no texto para personalizar a mensagem por comunidade.</small>
                    </div>
                            ...
                            <div>
                                ...
                                <div style="color: var(--text-dim); font-size: 0.85rem; margin-top: 4px;">
                                    ...
                                    <?php
                                        ...
                                        $comLabel = match($com) {
                                            'global' => '<img src="https://flagcdn.com/w20/us.png" style="width:16px; margin-right:5px; border-radius:2px;" alt="US"> Global (todos)',
