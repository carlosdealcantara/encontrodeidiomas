    ...
    <header class="header">
        <div class="header-content">
            ...
            <nav class="nav-links" id="main-nav" aria-label="Navegação principal">
                ...
                <a href="online.php"  <?= $current_page === 'online.php'  ? 'class="active" aria-current="page"' : '' ?>>Encontros Online</a>
                <a href="equipe.php"  <?= $current_page === 'equipe.php'  ? 'class="active" aria-current="page"' : '' ?>>Conheça a Equipe</a>
                <a href="links.php"   <?= $current_page === 'links.php'   ? 'class="active" aria-current="page"' : '' ?>>Central de Links</a>
