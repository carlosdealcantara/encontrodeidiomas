...
<head>
    ...
    <meta property="og:image"       content="<?= SITE_URL ?>/assets/images/og_preview_minimal.png?v=2.2">
    ...
    <meta property="twitter:image"       content="<?= SITE_URL ?>/assets/images/og_preview_minimal.png?v=2.2">
