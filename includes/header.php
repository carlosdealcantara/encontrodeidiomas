...
<head>
    ...
    <meta property="og:image"       content="<?= SITE_URL ?>/assets/images/og_preview_v6.png?v=6.0">
    ...
    <meta property="twitter:image"       content="<?= SITE_URL ?>/assets/images/og_preview_v6.png?v=6.0">
