...
<head>
    ...
    <meta property="og:image"       content="<?= SITE_URL ?>/assets/images/og_preview_small.png?v=7.0">
    ...
    <meta property="twitter:image"       content="<?= SITE_URL ?>/assets/images/og_preview_small.png?v=7.0">
