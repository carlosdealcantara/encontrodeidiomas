...
<head>
    ...
    <meta property="og:image"       content="<?= SITE_URL ?>/assets/images/og_preview_red_final.png?v=3.0">
    ...
    <meta property="twitter:image"       content="<?= SITE_URL ?>/assets/images/og_preview_red_final.png?v=3.0">
